...
<script type="text/javascript">
		...
		function updatePostBoard() {
			...
			xmlhttp.open("GET", "personalShareReturn.jsp?t=" + Math.random(), true);
			xmlhttp.send();
		}
		...
		function submitPost() {
			...
			if (post_content != "") {
				...
				if (xmlhttp != null) {
					...
					var send_content = "submitPersonalShare.jsp?post_title="+post_title+"&book_title="+book_title+"&post_content="+post_content;
					...
					document.getElementById("myPost").value= "闲来无事闷得慌，来一发分享吧";
					document.getElementById("myPost").style.color= "#C8C8C8";
					document.getElementById("myPost").style.borderColor="#E1E1E1";
					
					document.getElementById("post_title").value= "题目";
					document.getElementById("post_title").style.color= "#C8C8C8";
					document.getElementById("post_title").style.borderColor="#E1E1E1";
		...
		function postTitleOnblur(text_)
		{
			if(text_.value=="")
			{	
				text_.value= "题目";
		...
		function postTitleOnfocus(text_)
		{
			if(text_.value=="题目")
				text_.value= "";
		...
		{
			if(text_.value.substring(0,14)=="闲来无事闷得慌，来一发分享吧")
				text_.value= "";
			text_.style.color="black";
			text_.style.borderColor="green";
		}
...
<body style="background-color:#D9D9D9">
	...
	<div class="postPaid">
	    <textarea id="post_title" onfocus="postTitleOnfocus(this)" onblur="postTitleOnblur(this)" style="color:#C8C8C8">题目</textarea>
	    <textarea id="book_title" onfocus="postBookTitleOnfocus(this)" onblur="postBookTitleOnblur(this)" style="color:#C8C8C8">书名</textarea>
		<textarea id="myPost" onfocus="postOnfocus(this)" onblur="postOnblur(this)" style="color:#C8C8C8">闲来无事闷得慌，来一发分享吧</textarea>
		<script> 
